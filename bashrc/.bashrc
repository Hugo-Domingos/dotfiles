...
export PYTHONPATH=$PYTHONPATH:/home/hugo/tensorflow/models/research/:/home/hugo/tensorflow/models/research/slim
...
# script to scale the monitor

alias scale-text='$HOME/scale-text.sh "$@"'
